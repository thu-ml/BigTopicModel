#ifndef SRC_MODEL_FastLDA_FastLDA_H_
#define SRC_MODEL_FastLDA_FastLDA_H_
...
public :
    ...
    // Auxiliary data structures for FastLDA
    int update_interval, active_size;
    ...
    FastLDA(TIter iter, TTopic K, TProb alpha, TProb beta, CVA<int> &corpus,
        ...
        LocalMergeStyle local_merge_style, int update_interval, int active_size)
            : K(K), alpha(K, alpha), beta(beta), alphaBar(alpha * K),
              ...
              update_interval(update_interval), active_size(active_size) {
        /*
        printf("pid %d FastLDA constructor row_size : %d, column_size : %d, process_size : %d, process_id : %d, thread_size : %d\n",
                process_id, cwk.row_size, cwk.column_size, cwk.process_size, cwk.process_id, cwk.thread_size);
        printf("pid %d FastLDA constructor row_head : %d, row_tail : %d\n", cwk.process_id, cwk.row_head, cwk.row_tail);
                */
    ...
    void iterWord(bool is_fast_iteration);
...
#endif  // SRC_MODEL_FastLDA_FastLDA_H_
